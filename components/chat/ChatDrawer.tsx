...
export default function ChatDrawer({ isOpen, onClose, projectId, candidateId, title, members, currentUserId }: ChatDrawerProps) {
  ...
  return (
    <div className={`fixed inset-y-0 right-0 w-96 bg-white shadow-2xl transform transition-transform duration-300 z-[100] flex flex-col border-l border-gray-200 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      {/* Header */}
