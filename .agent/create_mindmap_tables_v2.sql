...
CREATE TABLE "MindMapNode" (
    ...
    "projectId" BIGINT NOT NULL, -- Changed from UUID to BIGINT to match Project.id
    "scope" TEXT NOT NULL DEFAULT 'team', -- 'team' or 'personal'
    "label" TEXT NOT NULL,
    "positionX" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "positionY" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "authorId" UUID NOT NULL, -- Profile ID (Assuming UUID)
...
CREATE TABLE "MindMapEdge" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "projectId" BIGINT NOT NULL, -- Changed from UUID to BIGINT
    "scope" TEXT NOT NULL DEFAULT 'team', -- 'team' or 'personal'
    "sourceId" UUID NOT NULL,
    "targetId" UUID NOT NULL,
    "label" TEXT,
    "authorId" UUID NOT NULL, -- Profile ID
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Policies for MindMapEdge (Same logic)
